...
delete.addActionListener(e -> {
 ...
 hi.showBack();
          ...
          Label ta = new Label("Prix Toral: " +String.valueOf(somme) + " Dt");
          hi.add(ta);
     ...
     public SwipeableContainer createRankWidget(Panier l,int id,String nom, int prix,Resources res) {
            ...
            Button reserver = new Button("Payer");
...
/*public SwipeableContainer button (){
    Button commenter = new Button("Commenter");
          commenter.addActionListener(e -> {
            
              
        });
          return new SwipeableContainer(FlowLayout.encloseCenterBottom(button()),commenter);
}*/
