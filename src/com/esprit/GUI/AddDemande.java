...
public class AddDemande {
    ...
    public AddDemande(Resources res) {
        ...
        TextField cv = new TextField("", "cv", 201, TextField.ANY);
        cv.setHint("Le cv de votre Demande ");
        ...
        dem.addActionListener(e -> {
            ...
            Message msg = new Message("blog added");
                Display.getInstance().sendMessage(new String[] {"hajouwa1998@gmail.com"}, "blog", msg);
