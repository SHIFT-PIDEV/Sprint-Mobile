...
public class displayonePack {
 ...
 private Resources theme;
    ...
    public displayonePack(Packge l,Resources res)
    {
             
 
//    String img=l.getImage_name();
    String url="http://127.0.0.1:8000/uploads/"+l.getImage();
   
        hi.getToolbar().setTitleComponent(
                FlowLayout.encloseCenterMiddle(
                        new Label(l.getNompackage(), "Title")
        ...
        TextArea popupBody = new TextArea("Titre:"+ l.getNompackage()+ "\n\n" +"prix:"+ l.getPrix()+"dinars" + "\n\n"+ "Nombre de cours:"+ l.getNbr_cour()+ "\n\n" +"categorie:"+ l.getCategorie()+  "\n\n"+  "Description:"+ l.getDescription()+  "\n\n" +"cour1:"+ l.getCourp()+  "\n\n"+ "cour2:"+ l.getCourpp()+  "\n\n"+ "cour3:"+ l.getCourppp()+  "\n\n"  , 8, 12);
