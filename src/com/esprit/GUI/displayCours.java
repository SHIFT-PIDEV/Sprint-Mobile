 ...
 * @author mahdi
 */
public class displayCours {
      public static int idu=3;
    public static int idl=0;
    Form hi = new Form("", new BoxLayout(BoxLayout.Y_AXIS));
//h.add(lb);
  public displayCours(Resources res) {
...
private Slider createStarRankSlider() {
   ...
   private void initStarRankStyle(Style s, Image star) {
    ...
    s.setBgTransparency(0);
       ...
       private void dialog(Cour e,Resources res) {
       
        Dialog d = new Dialog(e.getNom_cour());
       // String img=e.getImage_name();
        TextArea popupBody = new TextArea( e.getNom_cour()+ "\n" + e.getNiveau()+ "\n" + e.getPrix()+ "\n" + e.getFormateur()+ "\n" , 8, 12);
